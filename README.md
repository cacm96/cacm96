...
* Experienced in React, Next.js, TypeScript, Bootstrap, and other frontend technologies such as styled-components, Chakra UI
* Strong understanding of HTML, CSS, and JavaScript
* Ability to design and implement user interfaces that are both functional and visually appealing
* Passionate about creating innovative and user-friendly web applications
* Strong manage of responsive design
* Familiar with pixel perfect technique
* Successfully delivered several projects on time and within budget
...
![image](https://img.shields.io/badge/rollup%20js-EC4A3F?style=for-the-badge&logo=rollup.js&logoColor=white)
...
* Bachelor of Informatics Engineering from Universidad Centro Occidental Lisandro Alvarado

  
## Contact

If you have any question or want to contact me, hit me up @ carloscolmenarez1996@gmail.com or via [LinkedIn](https://www.linkedin.com/in/cacm96/)

<!--
**cacm96/cacm96** is a ✨ _special_ ✨ repository because its `README.md` (this file) appears on your GitHub profile.
